...
const translation = {
  ...
  "Tour": {
    "GuideTitle": "Welcome to VeriDID Wallet",
    "WouldYouLike": "Would you like some guidance on how to use VeriDID Wallet?",
  ...
  "CameraDisclosure": {
    ...
    "ToContinueUsing": "To continue using the VeriDID Wallet scan feature, please allow camera permissions.",
  ...
  "PushNotifications": {
    ...
    "NotificationsOffTitle": "Notifications for VeriDID Wallet are turned off",
  ...
  "Scan": {
    ...
    "ScanOnySpecial": "Only special QR codes can be scanned by VeriDID Wallet.",
    ...
    "ScanOnlySpecial3": "VeriDID Wallet currently doesn't support adding digital credential by scanning or taking photos of physical ones.",
    "WhereToUseLink": "See where you can use VeriDID Wallet",
    "BadQRCode": "QR Code Not Recognized",
    "BadQRCodeDescription": "Ths QR code scanned doesn't work with VeriDID Wallet. VeriDID Wallet only works with participating services.\n\nIt currently can't add digital credentials by taking photos of physical ones.",
  ...
  "Preface": {
    ...
    "Paragraph1": "Most people will not have a need for VeriDID Wallet because very few digital credentials are currently available.",
